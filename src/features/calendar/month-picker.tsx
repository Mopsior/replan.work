    ...
    return (
        <div
            className={cn([
                ...
                'not-md:after:fixed after:left-0 after:-bottom-0.5 after:h-16 after:w-full after:bg-linear-to-t after:from-background after:via-background/90 after:to-transparent after:pointer-events-none after:content-[""]',
            ])}
        >
